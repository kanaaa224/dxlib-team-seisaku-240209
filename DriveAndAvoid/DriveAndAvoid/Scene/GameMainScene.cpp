...
GameMainScene::GameMainScene() :high_score(0), back_ground(NULL), gamemainscene_image(NULL), barrier_image(NULL), mileage(0), player(nullptr), comment(nullptr), commentDatas(nullptr), commentDatas_num(0)
{
	for (int i = 0; i < 3; i++)
	{
		enemy_image[i] = NULL;
